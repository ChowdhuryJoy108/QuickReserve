  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-lg sm:text-xl text-gray-600 lg:w-2/3 mx-auto">
      ...
      {/* Radisson Blu Global Hotel Chain Description */}
      <motion.div
      ...
      >
        ...
        <motion.p
          className="text-sm sm:text-base text-justify text-gray-600 mb-4"
        ...
        >
          In Bangladesh, Radisson Blu has made its mark as a symbol of luxury and
          modern hospitality. Radisson Blu Chittagong stands at the forefront of
          the brand's presence in the country, offering guests a world-class
          experience. Located in one of the most vibrant cities, this hotel is
          designed to cater to both business and leisure travelers, featuring
          spacious rooms, fine dining options, and a variety of recreational
          facilities. Radisson Blu Chittagong is a perfect blend of contemporary
          comfort and local culture, offering panoramic views of the city.
        </motion.p>

        <motion.p
          className="text-sm sm:text-base text-justify text-gray-600"
          initial={{ opacity: 0, x: -50 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 1, delay: 0.4 }}
        >
          Around the world, Radisson Blu continues to expand its footprint,
          maintaining its reputation for excellence. Each hotel is carefully
          designed to provide an experience that reflects both the global brand
          and the local environment, making every stay unique and unforgettable.
          Whether you’re in Europe, Asia, Africa, or the Americas, Radisson Blu
          promises to deliver a luxurious experience wherever you go.
        </motion.p>
      </motion.div>
    </motion.div>
  );
