...
import backgroundImage from "../../assets/check.webp";
...
const Home = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8000/room-reviews")
  ...
  return (
    <div>
      ...
      <Carousel className="rounded-xl mb-[100px]">
        ...
        <div
          className="relative flex flex-col items-center space-y-4 my-[50px] h-[350px] bg-cover bg-center text-white py-16 px-4 lg:h-[500px] "
          style={{
        ...
        >
          ...
          <div className="relative z-10 text-center  lg:top-32">
            ...
            <p className="w-full text-center ml-24 text-gray-200 lg:w-[700px]">
